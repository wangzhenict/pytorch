...
We recommend most models use the global ProcessGroup registration and dist.*
...
* These APIs use per ProcessGroup ranks rather than the global ranks.

.. autoclass:: ProcessGroup
    :members:
    :special-members: __init__

.. autoclass:: ProcessGroupGloo
    :members:
    :special-members: __init__

.. autoclass:: ProcessGroupNCCL
    :members:
    :special-members: __init__

The other ProcessGroup backends (such as UCC and MPI) are conditionally built so
not documented here.
